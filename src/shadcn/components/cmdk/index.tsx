...
import { FormInput, TFormInputProps } from '@/shared/ui/form-input';
import { Input as ShadInput } from '@/shadcn/components/ui/input.tsx';
...
type InputProps = Omit<TFormInputProps, 'value' | 'onChange' | 'type'> & {
  /**
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (props, forwardedRef) => {
    ...
    // привести API к новому инпуту
    // сейчас почему то прозрачный фон, нет лайблов нет текста
    console.log(etc);
    return (
      <FormInput
        ref={forwardedRef}
